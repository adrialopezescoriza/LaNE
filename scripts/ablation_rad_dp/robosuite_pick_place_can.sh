python train.py --domain_name robosuite_pick_place_can \
  ...
  --observation_type pixel --encoder_type pixel --work_dir ./data/robosuite_pick_place_can/ablation_rad_dp \
  ...
  --seed 1 --num_eval_episodes 20 --encoder_feature_dim 32 --final_demo_density 0.2